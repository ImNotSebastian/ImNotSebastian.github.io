...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-center">
      ...
      <p>These Terms of Service govern your use of the iCare platform and website ("Service"), provided by iCare LLC. By accessing or using the Service, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use the Service.</p>
	   <hr>
      ...
      <p>You may use the Service only for lawful purposes and in accordance with these Terms. You agree not to engage in any conduct that restricts or inhibits anyone's use or enjoyment of the Service or could damage, disable, overburden, or impair the Service.</p>
	   <hr>
      <h3>Fees and Payments</h3>
      <p>By using the Service, you agree to pay all applicable fees and charges. We reserve the right to charge a service fee of 5% for any services purchased through the application. All fees are non-refundable except as expressly provided in these Terms or as required by law.</p>
	   <hr>
      <h3>Limitation of Liability</h3>
      <p>To the fullest extent permitted by law, in no event will iCare LLC be liable for any indirect, incidental, consequential, special, or punitive damages arising out of or relating to your use of the Service.</p>
	   <hr>
      <h3>Termination</h3>
	  ...
	  <hr>
	  <b>By using the iCare platform, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</b>
    </div>
    <div class="col-sm-2 sidenav">
      <div class="well">
        <p>Ad for Service</p>
